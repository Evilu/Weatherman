  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Auth Form Card */}
        <Card className="weather-card border-slate-800 bg-slate-900/50 backdrop-blur-xl overflow-hidden shadow-2xl">
          <CardHeader className="text-center pb-4 border-b border-slate-800/50">
              ...
              {!isLogin && (
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required={!isLogin}
                    className="h-11 text-sm font-medium text-slate-100 bg-slate-800/30 border-slate-700 focus:border-blue-500 placeholder:text-slate-500"
                  />
                </div>
              )}
